#!/usr/bin/env bash
# QwenPI_v3 training on LIBERO with Qwen-VL unfrozen.
# Usage: bash examples/LIBERO/train_files/run_libero_train_qwenpi_v3_unfreeze.sh
...
run_id=libero4in1_qwenpi_v3_unfreeze

# === QwenPI_v3-specific knobs ===
# Compress Qwen hidden states (e.g. 2560 for Qwen3-VL-4B) before the Action DiT.
...
# Unfreezing Qwen increases memory use; keep the initial batch conservative.
