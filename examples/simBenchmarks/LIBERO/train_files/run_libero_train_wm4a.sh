#!/usr/bin/env bash
# WM4A (CosmoPredict2GR00T) training on LIBERO — single-node 4-GPU, no DeepSpeed
# Usage: bash examples/LIBERO/train_files/run_libero_train_wm4a.sh
...
run_id=wm4a_cosmo_groot_libero_4gpu_nodeepspeed2
# === 结束 ===
###############################################################################
